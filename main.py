...
class APP:
    def __init__(self):
        ...
        self.time_span=0.000000000000000000000000000000000000000000001 #名字显示间隔
    ...
    def create_widget(self):
        ...
        self.label_show_name=ttk.Label(self.root,textvariable=self.label_show_name_var,font=('MSYH', 100,"bold"),foreground = '#1E90FF')
